...
Google版仅在Windows平台测试过，Linux或Mac平台应该也适用。
IE版仅支持Windows平台。
...
4. 在python的命令行终端中运行 python ‘绝对路径’\Auto_Login_XX_version_Main.py.py即可
...
这里提供了与浏览器71.0.3578.98版本对应的win32位71.0.3578.80版本浏览器驱动（win64亦可用）。
...
#########################################################
IE浏览器版本
基于windows自带IE浏览器实现，依赖于浏览器自动化测试框架selenium，
需下载与selenium版本相对应的浏览器驱动“IEDriverServer”配合使用，
这里提供了与selenium-3.141.0版本对应的win64位3.141.5版本IE浏览器驱动。

IE浏览器驱动下载地址http://selenium-release.storage.googleapis.com/index.html
#########################################################
...
https://jingyan.baidu.com/article/154b46313de90c28ca8f41ac.html
